...
Revision ID: 9cc6a4346298
Revises: 
Create Date: 2025-04-15 02:28:56.003457
...
def upgrade() -> None:
    ...
    op.create_index('ix_assert_project_id', 'assets', ['asset_project_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_assert_project_id', table_name='assets')
